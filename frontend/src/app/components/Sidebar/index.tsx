  ...
  return (
    <>
        ...
        <div className="flex flex-col items-start gap-[40px] absolute w-[130px] h-[91px] left-[46px] top-[183px]">
          ...
          className="flex flex-row items-center px-6 gap-[26px] w-[95px] h-[23px] order-0 flex-grow-0 cursor-pointer">
          <svg 
          ...
          fill={activeItem === 'Inicio' ? '#F72793' : '#CECDCD'}/>
          </svg>
          <p
          className={`w-[46px] h-[22px] px-6 font-medium text-[18px] leading-[22px] ${activeItem == 'Inicio' ? 'text-[#F72793]' : 'text-[#CECDCD]' } flex-none order-1 flex-grow-0`}
          >Inicio</p>
          </div>
          <div 
          onClick={() => onItemClick('Usuarios')}
          className="flex flex-row items-center p-0 gap-6 w-[130px] h-[28px] flex-none order-1 flex-grow-0 cursor-pointer">
          <svg 
          ...
          fill={activeItem === 'Usuarios' ? '#F72793' : '#CECDCD'}/>
          </svg>
          <p
          className={`w-[76px] h-[22px] font-inter font-medium text-[18px] leading-[22px] ${activeItem == 'Usuarios' ? 'text-[#F72793]' : 'text-[#CECDCD]' } flex-none order-1 flex-grow-0`}
          >Usuarios</p>
          </div>
        </div>
    </>
